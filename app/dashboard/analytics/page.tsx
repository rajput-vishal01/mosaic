...
import { deriveDashboardFreshness } from "@/features/connections/dashboard-freshness";
...
export default async function AnalyticsPage() {
  ...
  const freshness = deriveDashboardFreshness(accounts);
  const freshnessTone = {
    ...
    reconnect_required: "border-amber-200 bg-amber-50 text-amber-900",
    unavailable: "border-slate-200 bg-white text-slate-700",
  }[freshness.state];
