...
**Status:** In progress — domain model, searchable fixture catalog, multi-client grants, scope resolver, and filtered audit viewer delivered (2026-09-01)
...
**Status:** In progress — scheduled Airbyte ingestion, replay-safe GA4 provisioning, transactional raw-data normalization, warehouse-scope publication, retained sync-run diagnostics, grant-resolved Superset embedding, per-client freshness, and safe revocation delivered behind infrastructure readiness gates (2026-09-04)
