...
**Status:** In progress — scheduled Airbyte ingestion, replay-safe GA4 provisioning, transactional warehouse-scope publication, grant-resolved Superset embedding, per-client freshness, and safe revocation delivered behind infrastructure readiness gates (2026-09-03)
